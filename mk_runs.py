...
on["NGC4388+vicinity"] = [ 
			   ...
			   112708, 112709, 112713, 112714, 112718, 112719, 112723, 
	                   ...
	                   112826, 112827, 112985, 112986, 112988, 112989, 
                           ...
                           116505, 116506, 117006, 117007, 117009, 117101,
...
pars1 = {}
pars1["NGC4388+vicinity"] = "pix_list=-13  dv=250 dw=300 b_order=1 qagrade=3"
#                         = "dv=350 dw=400 b_order=1 otf_cal=1"   # from UM-8


#        common parameters per source on subsequent runs (run1b, run2b), e.g. bank=0 for WARES
pars2 = {}
pars2["NGC4388+vicinity"] = "pix_list=-13 qagrade=3"
